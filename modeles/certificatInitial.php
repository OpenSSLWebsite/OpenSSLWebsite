...
$dn = array(
    ...
    "commonName" => "Universite de Nice Sophia Antipolis",
...
openssl_csr_export_to_file($csr, "requeteSignatureP.txt");
openssl_x509_export_to_file($sscert, "certificat.txt");
openssl_pkey_export_to_file($privkey, "cles.txt", "monmot2passe");
